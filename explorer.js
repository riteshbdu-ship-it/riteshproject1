...
function syncGitLabData(inputUrl) {
  ...
  let rawUrl = inputUrl || 'https://gitlab.com/crossref/retraction-watch-data/-/blob/main/retraction_watch.csv?ref_type=heads';
...
function initExplorer() {
  ...
  if (filterCount) filterCount.textContent = '71,133';
